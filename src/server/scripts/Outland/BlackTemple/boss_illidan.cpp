            ...
            while (uint32 eventId = _events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_AKAMA_MINIONS_EMOTE:
                        ...
                        me->SetFlag(UNIT_NPC_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC);
...
public:
    ...
    class spell_maiev_down_AuraScript : public AuraScript
    {
        ...
        {
            GetTarget()->SetFlag(UNIT_NPC_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
        }

        void HandleEffectRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            GetTarget()->RemoveFlag(UNIT_NPC_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
